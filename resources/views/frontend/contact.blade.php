...
<div class="row mt-5">
    <div class="col-md-8">
        ...
        <div class="row bg-info mx-auto" data-aos="fade-right">
            ...
            <div class="col-md-4 d-flex mx-auto">
                <i class="bi bi-facebook p-3 mt-2"></i><a class="mt-4 text-decoration-none text-dark" href="https://www.facebook.com/somosotdentalbohol"><p class="text-decoration-none">Somosot Dental Bohol</p></a>
            </div>

            <div class="col-md-4 ms-auto">
                <h6 class="fw-bold">Opening Hours:</h6>
                <p>Monday-Saturday <br>8:00am - 5:00pm</p>
            </div>
        </div>
    ...
    <div class="col-md-4 mt-3 embed-responsive" data-aos="zoom-in">
        ...
        <a class="btn btn-primary d-block" target=”_blank” href="{{url("https://www.google.com/maps/place/88+Santos+Baura+St,+Tubigon,+6329+Bohol/@9.9487936,123.9626889,21z/data=!4m5!3m4!1s0x33aa2f70b74d642d:0x85a7b25524fc1cc0!8m2!3d9.9487457!4d123.9628009")}}">Get Directions</a>
    </div>
</div>
</div>
