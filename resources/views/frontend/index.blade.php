    ...
    @foreach ($promotions as $key => $promotionItem)
      ...
      <div class="carousel-item {{ $key == 0 ? 'active':'' }}">
        ...
        @if($promotionItem->image)
            ...
            class="d-block w-100 img-fluid" alt="promotion" style="width:auto; height:45vw; background-size: cover;">
        @endif
        <div class="carousel-caption">
            <div class="float-center">
                <h2 class="fw-bold" style="font-size:4vw;"><span>{{$promotionItem->title}}</span></h2>
                <p class="text-white fw-light text-center" style="font-size:2vw;">{{$promotionItem->description}}</p>
                <a class="btn btn-sm btn-info" type="button" href="{{url('/set-appointment')}}">Book Appointment</a>
                <a class="btn btn-sm btn-info" type="button" href="{{url('/services')}}">View services</a>
            </div>

            {{-- <div class="bg-dark opacity-25 p-5 ms-auto mb-3">
                ...
                <div class="row g-2" >
                    <div class="col-md-4 d-flex">
                        <div>
                            ...
                            <p class="text-justify">Going to the dentist can be intimidating or scary for many people. The buzzing sounds, the x-ray machines, the big chairs – it can all be a little overwhelming. If you know what you’re in for, though, your experience will be much easier to handle.</p>
