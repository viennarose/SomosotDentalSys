                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="ans1" class="form-control" col="5" rows="5" value="{{ $setting->ans1 ?? ''}}">{{ $setting->ans1 ?? ''}}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="ans2" class="form-control" col="5" rows="5" value="{{ $setting->ans2 ?? ''}}">{{ $setting->ans2 ?? ''}}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="ans3" class="form-control" col="5" rows="5" value="{{ $setting->ans3 ?? ''}}">{{ $setting->ans3 ?? ''}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
