          ...
          <div class="tab-content py-0 px-0">
            <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
              <div class="d-flex flex-wrap justify-content-xl-between">
                ...
                <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                  <div class="d-flex flex-column justify-content-around">
                    <small class="mb-1 text-muted">Total Patient Records</small>
                    <h1 class="text-center">{{$totalPatientRecords}}</h1>
                    <a href="{{ url('admin/testimonies')}}" class="btn btn-sm bg-info">view</a>
                  </div>
                </div>
              </div>
                ...
                <div class="d-flex flex-wrap justify-content-xl-between">
                  <div class="d-flex d-xl-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                    <div class="d-flex flex-column justify-content-around">
                      <small class="mb-1 text-muted">Total Patient Records</small>
                        <h1 class="text-center">{{$totalPatientRecords}}</h1>
                          <a href="{{ url('admin/patients')}}" class="btn btn-sm bg-info">view</a>
                    </div>
                  </div>
                  <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                    <div class="d-flex flex-column justify-content-around">
                      <small class="mb-1 text-muted">Total Treatment Records</small>
                      <h1 class="text-center">{{$totalTreatmentRecords}}</h1>
                      <a href="{{ url('admin/patients')}}" class="btn btn-sm bg-info">view</a>
                    </div>
                  </div>
                </div>
