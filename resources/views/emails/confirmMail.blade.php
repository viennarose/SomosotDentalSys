...
<body>
        ...
        <tbody>
            ...
            <tr>
                <td><span style="font-weight: bold">Appointment Schedule:</span> {{\Carbon\Carbon::parse($schedule)->format('F j, Y h:i a')}} <br>
                    Please be at the clinic at least 10 minutes before your scheduled time. Thank you!
                </td>
    ...
    <br>
    <p class="text-center">
        You have successfully set your appointment. Thank you for choosing Somosot Dental Clinic!
    </p>
